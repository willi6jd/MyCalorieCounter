...
class FoodActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnCreate = findViewById<Button>(R.id.btnCreateFoodItem) //Create food item button

        btnCreate.setOnClickListener {

            // Get input fields. Store them to food item variables
            var itemName = findViewById<EditText>(R.id.listFoodName) //Name of food item: input text field
            var itemCalories = findViewById<EditText>(R.id.listFoodCal) //Calorie amount of food item: integer
            var itemSugar = findViewById<EditText>(R.id.listFoodSugar) //Sugar amount of food item: integer
            var itemProtein = findViewById<EditText>(R.id.listFoodPro) //Protein amount of food: integer
...
//            return textView
            ...
            val fatTextView = rowMain.findViewById<TextView>(R.id.listFoodSugar)
